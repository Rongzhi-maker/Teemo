 ...
 */
public class YLMultiRecycleAdapter2 extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public YLMultiRecycleAdapter2 itemAdapter(YLRecycleAdapter<?>... itemAdapter) {
...
//            adapter.setMultiAdapter(this);
    ...
    public <H> YLMultiRecycleAdapter2 headCreator(IViewHolderCreator<H> headCreator) {
        if (headCreator != null)
            this.headCreators.put(getHeaderCount() + head, headCreator);
        return this;
    }

    public <F> YLMultiRecycleAdapter2 footCreator(IViewHolderCreator<F> footCreator) {
        if (footCreator != null)
            this.footCreators.put(getFooterCount() + foot, footCreator);
        return this;
    }

    public YLMultiRecycleAdapter2 viewAttachListener(ViewAttachedToWindowListener listener) {
        this.viewAttachedToWindowListener = listener;
        return this;
    }

    public YLMultiRecycleAdapter2 preLoadNumber(int preLoadNumber) {
        this.preLoadNumber = preLoadNumber;
        return this;
    }

    public YLMultiRecycleAdapter2 preLoadListener(OnPreLoadListener onPreLoadListener) {
    ...
    public YLMultiRecycleAdapter2 setDataList(List dataList) {
